        ...
        <div className="mx-4 rounded-lg bg-lico-gray-4 p-8">
          <div className="flex flex-col items-center space-y-6">
            ...
            <button
              ...
              className="mt-6 rounded bg-lico-orange-2 px-6 py-2 font-bold text-white transition-colors hover:bg-lico-orange-1 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {updateProfileMutation.isPending ? '업데이트 중...' : '프로필 수정'}
            </button>
          </div>
        </div>
      </div>
